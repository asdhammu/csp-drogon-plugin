...
public class CSPDrogonParamDirectiveImpl extends ASTWrapperPsiElement implements CSPDrogonParamDirective {

  public CSPDrogonParamDirectiveImpl(@NotNull ASTNode node) {
    super(node);
  }
