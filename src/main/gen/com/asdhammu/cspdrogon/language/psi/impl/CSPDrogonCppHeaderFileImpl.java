...
public class CSPDrogonCppHeaderFileImpl extends ASTWrapperPsiElement implements CSPDrogonCppHeaderFile {

  public CSPDrogonCppHeaderFileImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CSPDrogonVisitor visitor) {
    visitor.visitCppHeaderFile(this);
  }
