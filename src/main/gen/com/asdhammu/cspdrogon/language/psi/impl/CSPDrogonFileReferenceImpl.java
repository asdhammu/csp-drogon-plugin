...
public class CSPDrogonFileReferenceImpl extends ASTWrapperPsiElement implements CSPDrogonFileReference {

  public CSPDrogonFileReferenceImpl(@NotNull ASTNode node) {
    super(node);
  }
