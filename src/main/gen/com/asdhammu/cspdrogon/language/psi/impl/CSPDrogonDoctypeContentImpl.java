...
public class CSPDrogonDoctypeContentImpl extends ASTWrapperPsiElement implements CSPDrogonDoctypeContent {

  public CSPDrogonDoctypeContentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CSPDrogonVisitor visitor) {
    visitor.visitDoctypeContent(this);
  }
